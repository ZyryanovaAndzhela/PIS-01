...
INSERT INTO service (description, start_date, end_date, price, id_administrator, instructions) VALUES
('Миграционный учет', '2023-01-01', '2026-01-01', 1000.00, 1, 'Вам необходимо обратиться к лицу, у которого проживаете, для того чтобы собственник помещения направил уведомление в УМВД через портал государственных услуг о постановке на миграционный учет иностранного гражданина по месту пребывания
'),
('Дактилоскопическая регистрация', '2023-01-01', '2026-01-01', 2000.00, 2, 'Вам необходимо обратиться в подразделения по вопросам миграции МВД России по Вашему месту нахождения либо в ФГУП «ПВС» МВД России'),
('Медицинское освидетельствования', '2023-01-01', '2026-01-01', 1000.00, 1, 'Вам необходимо обратиться в медицинские организации'),
('Полис', '2023-01-01', '2026-01-01', 800.00, 2, 'Необходимо обратиться в любую страховую компанию в месте пребывания'),
('Патент', '2023-01-01', '2026-01-01', 750.00, 1, 'Вам необходимо обратиться в УМВД России либо в ФГУП «ПВС» МВД России'),
('Сертификат о владении русским языком', '2023-01-01', '2026-01-01', 400.00, 2, 'Вам необходимо обратиться в образовательные учреждения (филиалы) по Вашему месту нахождения для сдачи экзамена и получения сертификата для оформления патента'),
('Выписка об оплате НДФЛ', '2023-01-01', '2026-01-01', 500.00, 1, 'Вам необходимо осуществлять платежи ежемесячно, либо авансово за 12 месяцев действия патента'),
('Фотографии в фотосалоне', '2023-01-01', '2026-01-01', 300.00, 2, 'Вам необходимы цветные фотографии 3х4'),
('ИНН', '2023-01-01', '2026-01-01', 900.00, 2, 'Вам необходимо обратиться в Инспекцию Федеральной налоговой службы'),
('Трудовой договор\дороговор ГПХ', '2023-01-01', '2026-01-01', 1000.00, 2, 'Вам необходимо трудоустроиться'),
('Уведомление об осуществлении трудовой деятельности', '2023-01-01', '2026-01-01', 1000.00, 2, 'Вам необходимо направить уведомление'),
('Отметка в качестве участника Гос. программы переселения соотечественников', '2023-01-01', '2026-01-01', 800.00, 2, 'Вам необходимо прибыть для постановки на учет в качестве участника Государственной программы в Управление по вопросам миграции МВД России'),
('Меры государственной поддержки', '2023-01-01', '2026-01-01', 800.00, 2, 'Вам необходимо обратиться в Управление по вопросам миграции МВД России'),
('Компенсации расходов по найму жилья', '2023-01-01', '2026-01-01', 800.00, 2, 'Вам необходимо обратиться в Центр занятости населения по месту пребывания');
...
INSERT INTO request (id_employee, id_foreigner, id_service, status, date_creation, date_completion, deadline, result) VALUES
(1, 1, 1, 'Завершена', '2023-03-15', '2023-03-18', '10 дней', 'Документ выдан'),
(1, 3, 1, 'Завершена', '2023-03-17', '2023-03-17', '10 дней', 'Документ выдан'),
(1, 2, 2, 'Завершена', '2023-03-19', '2023-03-25', '10 дней', 'Регистрация прошла успешно'),
(1, 1, 2, 'Завершена', '2023-03-21', '2023-03-22', '10 дней', 'Регистрация прошла успешно'),
(1, 1, 3, 'Создана', '2023-03-24', NULL, '10 дней', NULL),
(1, 2, 4, 'Завершена', '2023-03-22', '2023-03-28', '10 дней', 'Полис получен'),
(2, 2, 5, 'Обрабатывается', '2023-03-16', NULL, '10 дней', NULL),
(2, 1, 6, 'Отклонено', '2023-03-18', '2023-03-19', '10 дней', 'Недостаточно документов'),
(2, 3, 6, 'Создана', '2023-03-20', NULL, '10 дней', NULL),
(2, 3, 7, 'Отклонено', '2023-03-23', '2023-03-24', '10 дней', 'Не все платежи осуществлены');
