...
14. **UserRepository - User** (Зависимость): UserRepository управляет объектами User, предоставляя методы для сохранения, извлечения, обновления и удаления объектов User.

15. **ApplicationRepository - Application** (Зависимость): ApplicationRepository управляет объектами Application, предоставляя методы для сохранения, извлечения, обновления и удаления объектов Application.

16. **ServiceRepository - Service** (Зависимость): ServiceRepository управляет объектами Service, предоставляя методы для сохранения, извлечения, обновления и удаления объектов Service.

17. **RuleRepository - ServiceRule** (Зависимость): RuleRepository управляет объектами ServiceRule, предоставляя методы для сохранения, извлечения, обновления и удаления объектов ServiceRule.

18. **AccountRepository - Account** (Зависимость): AccountRepository управляет объектами Account, предоставляя методы для сохранения, извлечения, обновления и удаления объектов Account.
