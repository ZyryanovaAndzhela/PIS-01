...
21. **ApplicationService – Status, Service, User, CivilServant** (Ассоциация): ApplicationService использует объекты этих классов для выполнения своих операций (например, для создания, обновления и получения заявок).
